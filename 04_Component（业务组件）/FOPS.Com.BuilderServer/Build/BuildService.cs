...
namespace FOPS.Com.BuilderServer.Build
{
    ...
    public class BuildService : IBuildService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<List<BuildVO>> ToBuildingList(int top) => BuilderContext.Data.Build.Select(o => new {o.Id, o.Status, o.BuildNumber, o.IsSuccess, o.ProjectId,o.UseTime,o.FinishAt}).Desc(o => o.Id).ToListAsync(top).MapAsync<BuildVO, BuildPO>();
